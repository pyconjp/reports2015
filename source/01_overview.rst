...
チュートリアル・デイは講義形式で行われる有料のセッションで、講師の方は最大30名程の受講者の方へハンズオン、ワークショップ形式で講義を行います。
カンファレンス・デイでは、基調講演や多くのトークセッションが行われPyCon JPの目玉となる日です。
開発スプリントでは、参加者が集まりもくもくと開発を行います。
Pythonをあまり触ったことがない方々もこの開発スプリントの機会を利用しましょう！
...
`PyCon JP 2015: 子ども向けワークショップ - connpass <http://pyconjp.connpass.com/event/18813/>`_
